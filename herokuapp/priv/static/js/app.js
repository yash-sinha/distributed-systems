...
if (document.getElementById("signup")) // use this if you are using id to check
  {
    var new_username = document.querySelector('#username');
...
channel.on('signupres', function (payload) {
  var res = payload['res'];
...
channel.on('followres', function (payload) {
  var res = payload['status'];
  alert(res);
  var tofollow = document.querySelector('#tofollow');
  tofollow.value = "";
});
...
channel.on('signin', function (payload) {
  var username = document.querySelector('#username');
  var password = document.querySelector('#password');
  ...
  if (payload["status"] == "Logged in") {
    window.location.href = 'http://localhost:4000/home' + '/' + username.value;
  } else {
...
if (document.getElementById("btnTweet")) // use this if you are using id to check
  {
    var desc = document.querySelector('#tweetContent');
    var userID = getmyid();
    ...
    document.getElementById("tweetContent").addEventListener("keyup", function (event) {
      event.preventDefault();
      if (event.keyCode === 13) {
...
if (document.getElementById("btnFollow")) // use this if you are using id to check
  {
    ...
    document.getElementById("tofollow").addEventListener("keyup", function (event) {
      event.preventDefault();
      if (event.keyCode === 13) {
...
channel.on('redirect', function (payload) {
  window.location.href = 'http://localhost:4000/';
});

channel.on('gettweet', function (payload) {
  // alert("New tweet");
  console.log(payload);
...
channel.on('updatefeed', function (payload) {
  // alert("New tweet");
  console.log(payload);
  var tweet_list = $('#tweet-list');
...
channel.on('getmentions', function (payload) {
  console.log(payload);
...
if (document.getElementById("btnhashtag")) // use this if you are using id to check
  {
    var hash = document.querySelector('#hashtag');
    ...
    document.getElementById("hashtag").addEventListener("keyup", function (event) {
      event.preventDefault();
      if (event.keyCode === 13) {
...
channel.on('gethashtag', function (payload) {
